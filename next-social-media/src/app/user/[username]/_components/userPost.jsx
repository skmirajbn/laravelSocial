...
"use client";
import CommentLikeShareSection from "@/components/commentLikeShareSection";
...
export default function UserPost() {
  ...
  return (
    ...
    posts.map((post) => {
      ...
      return (
        <div key={post.post_id} className=" px-6 py-8 rounded-xl shadow-lg shadow-gray-400 space-y-5">
          <div className="flex items-center gap-3">
            <img className="w-12 h-12 rounded-full object-cover" src={process.env.NEXT_PUBLIC_BACKEND_URL + "/" + post?.user?.active_profile_image?.image_path} alt="" />
