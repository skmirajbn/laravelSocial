...
export default function UserCommentSection({ post }) {
        ...
        comments.map((comment) => (
          <div key={comment.comment_id}>
            <div className="flex gap-3">
              <img className="w-10 h-10 rounded-full object-cover" src={process.env.NEXT_PUBLIC_BACKEND_URL + "/" + comment?.user?.active_profile_image?.image_path} alt="" />
              <div>
